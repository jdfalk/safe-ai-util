#!/usr/bin/env python3
# Generated GitHub Projects assignment script for copilot-agent-util-rust

"""
Issue Assignment Script for copilot-agent-util-rust
...
# 1. mcp_github_list_issues(owner="jdfalk", repo="copilot-agent-util-rust")
