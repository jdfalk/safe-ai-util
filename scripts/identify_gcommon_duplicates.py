...
def identify_obvious_duplicates() -> Dict[str, List[int]]:
    ...
    duplicate_patterns = {
        ...
        "gcommon_protobuf_migration": [185, 180, 175, 170, 166, 160, 153, 147, 141, 135, 130],
        ...
        "organize_project_board": [162, 156, 150, 144, 138, 133, 129, 126, 124, 121, 119, 116, 114],
        
        # Add GRPCService implementations to SQLite and CockroachDB drivers (appears 20+ times)
        "grpc_database_implementation": [161, 155, 149, 143, 137, 132, 128, 125, 123, 120, 118, 115, 113, 110, 93, 82, 81, 80, 79, 78, 76, 75]
    }
    ...
    for pattern_name, issue_numbers in duplicate_patterns.items():
        ...
        if len(issue_numbers) > 1:
            ...
            for issue_num in to_delete:
                ...
                commands.append(
                    f'# Close duplicate issue {issue_num} ({pattern_name})'
                )
                commands.append(
