...
def categorize_issue(title: str, labels: List[str] = None) -> Dict[str, Any]:
    ...
    elif any(word in title_lower for word in ["ci", "workflow", "action", "automation"]):
            ...
            "copilot-agent-util-rust": {
                ...
                "issues": {
                    "2": {
                        ...
                        "state": "open",
                        "categorization": categorize_issue("Add configuration file support for build options"),
                    ...
                    "1": {
                        ...
                        "state": "open",
                        "categorization": categorize_issue("Implement cross-platform binary distribution"),
            ...
            "subtitle-manager": {
                ...
                "sample_issues": {
                    "456": {
                        ...
                        "state": "open",
                        "categorization": categorize_issue("Implement comprehensive subtitle format support"),
            ...
            "gcommon": {
                ...
                "sample_issues": {
                    "185": {
                        ...
                        "state": "open",
                        "categorization": categorize_issue("Complete GCommon Protobuf 1-1-1 Migration and Missing File Implementation", 
                                                         ["protobuf", "1-1-1-migration", "missing-files", "compilation-blocker"]),
                        "existing_labels": ["protobuf", "1-1-1-migration", "missing-files", "compilation-blocker"],
            ...
            "ghcommon": {
                ...
                "sample_issues": {
                    "65": {
                        ...
                        "state": "open", 
                        "categorization": categorize_issue("Implement comprehensive GitHub automation workflow"),
...
def main():
    ...
    print(f"Duplicates identified: {issue_data['summary']['duplicate_analysis']['gcommon_duplicates']}")
